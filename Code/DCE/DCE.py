...
def test():
   ...
   # print("länge alt: "+ str(len(old_poly)) + "länge neu: " + str(len(final_number_poly)))
    ...
    while(len(sort_arr)>= fNoP):
       ...
       # if indic >= NoP_temp:
        ...
        if indic == NoP_temp:
            ...
            if indic-1 == 0:
            # print("kbef_vals (indic =0)" + str(indic-1) + ", "+ str(1) + ", "+ str(get_number_of_points(DCE_Polygon)-1))ü
               # print("indic-1 ist 0")
               # print("0, 1, " + str(NoP-2))
        ...
        # print("kbef_res "+ str(k_bef))
            ...
            if indic+1 > NoP_temp:
               # print("indic + 1 ist größer als NoP temp")
        ...
        if (get_number_of_points(DCE_Polygon) == fNoP):
            ...
            print("indic+1 > NoPTemp act "+ str(indicP1_gr_NoPTemp_act))
            print("indic normal bef "+ str(indic_norm_bef))
            print("indic normal act "+ str(indic_norm_act))
            DCE_Polygon.plot()
            plt.show()
   ...
   # print("act indic" + str(sort_array_indic_act))
    if indic !=0:
        if sort_array_indic_bef[0].size == 0:
         #   print("hinzugefügt indic" + str(indic-1))
        ...
        if sort_array_indic_act[0].size ==0:
            print("hinzugefügt indic" + str(indic))
...
def calc_k_for_all_points(p):
    ...
    for i in range(NoP):
        if i == 0:
           # print("i ist null in Gesamtpunktberechnung" + str(i))
            temp = calc_k_with_points(p,i,1, (NoP-1))
           # print("i ()"+str(i)+ "), 1, "+ str(NoP-1))
           # print("k wert" + str(temp[0]))
...
def delete_point_from_polygon(p,index_of_point):
    ...
    #if len(array) >= 3:
  #  if len(array) <= index_of_point:  #irgendwie auch merkwürdig!
     #   print("irgendwie merkwürdig ")
      #  print("index")
