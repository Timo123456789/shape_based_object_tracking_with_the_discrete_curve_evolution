...
Eine Vereinfachung des detektierten Objekts kann außerdem eine Anonymisierung ermöglichen, da nur das Übertragen wird, was auch übertragen werden soll. Ein konkreter Anwendungsfall ist die Zählung von Personen, die durch die Discrete Curve Evolution anonymisiert wurden. Hier kann ein maschineller Lernalgorithmus durch die vereinfachte Erkennung und Abstraktion das Zählen deutlich schneller und einfacher ermöglichen.\\
Im Rahmen dieser Bachelorarbeit soll beispielhaft eine Methode implementiert werden, die eine Darstellung von vereinfachten Objekten ermöglicht, welche zur Zählung verwendet werden kann.
% \begin{itemize}
