...
\subsection{Shape Similarity Measure (SSM)}{
	...
	Damit sind alle relevanten Funktionen zur Durchführung der Berechnung des Formähnlichkeitsmaßes beschrieben und das Programm ist nach der Ausgabe des generierten Videos und der Statistikdatei abgeschlossen.
