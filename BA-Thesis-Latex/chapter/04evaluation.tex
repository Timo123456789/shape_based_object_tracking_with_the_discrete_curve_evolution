...
\subsection{Geringe und hohe DCE Substitution}
	...
	\begin{table}[ht]
		\caption{Einstellungen der verschiedenen DCE Substitutionsgrenzen}
		...
		Für die Ergebnisse bei dem 10-sekündigen Video siehe die Tabellen \ref{tab:Minor_More_DCE_SSMs_A10s} und  \ref{tab:YOLO8_minor_more_DCE_A10s} im Anhang. Diese Ergebnisse sind auf die gerade beschriebenen übertragbar, außer das alle Werte deutlich ansteigen. \\

		\begin{table}[ht]
			\centering
			\caption{Vergleich der Statistik bei 1 Sekunde Video (30 Frames) und verschiedenen DCE Substitutionsgrenzen}
			...
			\begin{table}[ht]
				\caption{Vergleich der SSMs bei verschiedenen DCE Substitionslimits bei einem 1-sekündigem Video (30 Frames)}
				\label{tab:Minor_More_DCE_SSMs_A1s}
				\centering
				\begin{tabular}{l|l|l|l}
				 & \textbf{\begin{tabular}[c]{@{}l@{}}geringe DCE\\ Punktgrenzen\end{tabular}} & \textbf{Referenz} & \textbf{\begin{tabular}[c]{@{}l@{}}hohe DCE\\ Punktgrenzen\end{tabular}} \\ \hline
				\textit{SSM pro Fr. und Kl. Auto} & 3,12 & 355,41 & 6638,88 \\ \hline
				\textit{SSM pro detektiertes Auto} & 101,02,90 & 102,52 & 1915,06 \\ \hline
...
\subsection{lange Testdatensätze}
{\Blindtext[4]}
% 	\section{Bewertung}
