...
\subsection{Shape Similarity Measure}{
	...
	\lstinputlisting[firstnumber=15, linerange={44-51,53,54,57,58,60,61}, caption={Ausschnitt 2 aus \protect\lstinline|calc_shape_similarity_compare_polygons| Funktion in shape\_sim\_meas.py}, label = {cd:shape_sim_meas_compare_poly_second.py}]{../Code/Shape_Similiarity/shape_sim_meas.py}
