%!TEX root = ../thesis.tex
\chapter{Implementierung} \todo{Titel ist noch doof.. Aber Implementierung greift \Ref{implementation_in_python} vor}
...
\section{1. YOLO Variante (EF Version, Jeder Frame einzeln )} {
	...
	\lstinputlisting[linerange={22,24,26,27,29,31,37,42}, caption={Ausschnitt aus yolo\_every\_frame.py}, label = {cd:part_of_yolo_every_frame.py}]{../Code/YOLO/yolo_every_frame.py}
...
\section{2. YOLO Variante (RV Version, direkte Verarbeitung)}{
...
\section{Shape Similarity Measure}{
	...
	\lstinputlisting[linerange={70,92,93,95,96,98,99,101,102,104}, caption={Ausschnitt aus \protect\lstinline|calc_shape_sim_compare_classes_in_one_frame| Funktion in sha\-pe\_sim\_me\-as.py}, label = {cd:shape_sim_meas_one_frame_first.py}]{../Code/Shape_Similiarity/shape_sim_meas.py} 
