...
\subsection{Geringe und hohe DCE Substitution} \
	...
	\begin{table}[ht]
		...
		Bei der Dauer der Prozessierung ist eine geringe Verbesserung zu einer kürzeren Dauer zu erkennen.\\
			\begin{table}[ht]
				\caption[Vergleich der Basisdaten bei 10 Sekunde Video (300 Frames) und verschiedenen DCE Substitutionslimits]{Vergleich der Basisdaten bei 10 Sekunde Video (300 Frames) und verschiedenen DCE Substitutionslimits (Quelle: eigene Darstellung; \ref{cd:listing_A10s_RV_minor_results.txt(Y8x)}, \ref{cd:listing_A10s_RV_more_results.txt(Y8x)})}
...
\subsection{Gleiche DCE Substitionslimits}{
	...
	\begin{table}[h]
		\centering
		\caption[Vergleich der Basisdaten bei 10 Sekunde Video (300 Frames) und verschiedenen gleichen DCE Substitutionslimits]{Vergleich der Basisdaten bei 10 Sekunde Video (300 Frames) und verschiedenen gleichen DCE Substitutionslimits (Quelle: eigene Darstellung; \ref{cd:listing_A10s_RV_minorSame_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_moreSame_results.txt(Y8x)})}
	...
	Bei der Prozessierungszeit ist eine etwas längere Dauer bei geringen gleichen Limits zu erkennen, während bei hohen gleichen Limits die Dauer fast gleich bleibt.
			\begin{table}[h]
				\centering
				\caption[Vergleich der SSM bei 10 Sekunde Video (300 Frames) und verschiedenen gleichen DCE Substitutionslimits]{Vergleich der SSM bei 10 Sekunde Video (300 Frames) und verschiedenen gleichen DCE Substitutionslimits (Quelle: eigene Darstellung; \ref{cd:listing_A10s_RV_minorSame_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_moreSame_results.txt(Y8x)})}
