...
{Die Formähnlichkeit der einzelnen Polygone zueinander wird einem Messwert  (s. Kap. \ref{theo:SSM} und \ref{py:Shape_Sim_Meas}) berechnet. Es wird zunächst auf allgemeine Erkenntnisse eingegangen und danach werden die Ergebnisse mit Klassenunterscheidung erläutert. Ein Beispielframe aus dem 10-sekündigen Datensatz ist in Abb. \ref{Bsp_ErgebRVA10s_Vidmat} zu sehen.\\
...
{	
	\begin{table}[h]
		\centering
		\caption[Vergleich der verschiedenen YOLO Modelle bei 10 Sekunde Video (300 Frames)]{Vergleich der verschiedenen YOLO Modelle bei 10 Sekunde Video (300 Frames) (Quelle: eigene Darstellung; \ref{cd:listing_A10s_EF_results.txt(Y8n)}; \ref{cd:listing_A10s_RV_results.txt(Y8n)}; \ref{cd:listing_A10s_EF_results.txt(Y8m)}; \ref{cd:listing_A10s_RV_results.txt(Y8m)}; \ref{cd:listing_A10s_EF_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_results.txt(Y8x)})}
...
\subsection{Formähnlichkeitsmesswert \label{subsec:SSM}}
\begin{table}[h]
	\caption[Vergleich der SSMs bei verschiedenen YOLO Modellen bei 10 Sekunde Video (300 Frames)]{Vergleich der SSMs bei verschiedenen YOLO Modellen bei 10 Sekunde Video (300 Frames) (Quelle: eigene Darstellung; \ref{cd:listing_A10s_EF_results.txt(Y8n)}; \ref{cd:listing_A10s_RV_results.txt(Y8n)}; \ref{cd:listing_A10s_EF_results.txt(Y8m)}; \ref{cd:listing_A10s_RV_results.txt(Y8m)}; \ref{cd:listing_A10s_EF_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_results.txt(Y8x)})}
...
\subsection{Geringe und hohe DCE Substitution} \
	...
	\begin{table}[ht]
		\caption[Einstellungen der verschiedenen DCE Substitutionsgrenzen]{Einstellungen der verschiedenen DCE Substitutionsgrenzen (Quelle: eigene Darstellung; \ref{cd:listing_A1s_RV_minor_results.txt(Y8x)}, \ref{cd:listing_A1s_RV_more_results.txt(Y8x)}, \ref{cd:listing_A10s_RV_minor_results.txt(Y8x)}, \ref{cd:listing_A10s_RV_more_results.txt(Y8x)})}
		...
		Bei der Dauer der Prozessierung ist eine geringe Verbesserung zu einer kürzeren Dauer zu erkennen.\\
			\begin{table}[ht]
				\caption[Vergleich der Basisdaten bei 10 Sekunde Video (300 Frames) und verschiedenen DCE Substitutionsgrenzen]{Vergleich der Basisdaten bei 10 Sekunde Video (300 Frames) und verschiedenen DCE Substitutionsgrenzen (Quelle: eigene Darstellung; \ref{cd:listing_A10s_RV_minor_results.txt(Y8x)}, \ref{cd:listing_A10s_RV_more_results.txt(Y8x)})}
				...
				\begin{table}[ht]
					\caption[Vergleich der SSMs bei verschiedenen DCE Substitionslimits bei einem 10-sekündigem Video (300 Frames) ]{Vergleich der SSMs bei verschiedenen DCE Substitionslimits bei einem 10-sekündigem Video (300 Frames) (Quelle: eigene Darstellung; \ref{cd:listing_A10s_RV_minor_results.txt(Y8x)}, \ref{cd:listing_A10s_RV_more_results.txt(Y8x)})}
...
\subsection{Gleiche DCE Substitionslimits}{
	...
	\begin{table}[h]
		\centering
		\caption[Vergleich der Basisdaten bei 10 Sekunde Video (300 Frames) und verschiedenen gleichen DCE Substitutionsgrenzen]{Vergleich der Basisdaten bei 10 Sekunde Video (300 Frames) und verschiedenen gleichen DCE Substitutionsgrenzen (Quelle: eigene Darstellung; \ref{cd:listing_A10s_RV_minorSame_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_moreSame_results.txt(Y8x)})}
	...
	Bei der Prozessierungszeit ist eine etwas längere Dauer bei geringen gleichen Limits zu erkennen, während bei hohen gleichen Limits die Dauer fast gleich bleibt.
			\begin{table}[h]
				\centering
				\caption[Vergleich der SSM bei 10 Sekunde Video (300 Frames) und verschiedenen gleichen DCE Substitutionsgrenzen]{Vergleich der SSM bei 10 Sekunde Video (300 Frames) und verschiedenen gleichen DCE Substitutionsgrenzen (Quelle: eigene Darstellung; \ref{cd:listing_A10s_RV_minorSame_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_moreSame_results.txt(Y8x)})}
				...
				\begin{table}[h]
					\centering
					\caption[DCE Substitutionslimits bei gleichen Limits für alle Klassen]{DCE Substitutionslimits bei gleichen Limits für alle Klassen (Quelle: eigene Darstellung; \ref{cd:listing_A10s_RV_minorSame_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_moreSame_results.txt(Y8x)})}
...
\subsection{Langer Testdatensatz}{
	...
	\begin{table}[h]
		\centering
		\caption[Vergleich der Basisdaten bei 30 Sekunden Video (900 Frames)]{Vergleich der Basisdaten bei 30 Sekunden Video (900 Frames) (Quelle: eigene Darstellung; \ref{cd:listing_A1s_RV_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_results.txt(Y8x)}; \ref{cd:listing_A30s_RV_results.txt(Y8x)})}
		...
		\begin{table}[h]
			\centering
			\caption[Vergleich der SSM bei 30 Sekunde Video (900 Frames)]{Vergleich der SSM bei 30 Sekunde Video (900 Frames) (Quelle: eigene Darstellung; \ref{cd:listing_A1s_RV_results.txt(Y8x)}; \ref{cd:listing_A10s_RV_results.txt(Y8x)}; \ref{cd:listing_A30s_RV_results.txt(Y8x)}) }
			...
			\textit{\begin{tabular}[c]{@{}l@{}}absolute Anz. detektierter\\ Autos (in Kl. pr. Fr.)\end{tabular}} & \begin{tabular}[c]{@{}l@{}}60\\ (2,03)\end{tabular} & \begin{tabular}[c]{@{}l@{}}525\\ (1,75)\end{tabular} & \begin{tabular}[c]{@{}l@{}}1591\\ (1,77)\end{tabular} \\ \hline
			\textit{} &  &  &  \\ \hline
