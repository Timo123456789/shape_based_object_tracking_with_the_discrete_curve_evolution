...
\section{\glqq You Only Look Once \grqq (YOLO)}
{
	...
	Im folgenden werden mehrere Begriffe und Abkürzungen für \Ref{Desc_YOLO_Alg} erklärt. \\
	\begin{figure}[ht]
		\centering
	...
	\subsection{Der YOLO Algorithmus \label{Desc_YOLO_Alg}} 
	...
	YOLO ist für den Anwendungszweck dieser Arbeit geeignet, weil der Algorithmus die entsprechende Performance und einfache Verfügbarkeit von trainierten Modellen bietet.
	} 
}
...
\end{equation}
 ...
 \begin{figure}[ht]
	   \centering
	   \includegraphics*[scale = 0.65, keepaspectratio, trim=2 2 2 2 ]{images/schem_maps_paper_DCE.png}
