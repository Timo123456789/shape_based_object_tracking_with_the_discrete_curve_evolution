...
\section{Formähnlichkeitsmaß (NICHT FERTIG)}{
	\todo{muss noch geschrieben werdne}
	\todo{soll ich das überhaupt noch näher erläutern ? RM fragen.. Welche Quellen angeben}
...
{  \label{sec:Python}
	...
	In dieser Arbeit wird Anaconda als Installationsumgebung und Visual Studio Code als Entwicklungsumgebung genutzt. Im Folgenden werden die in dieser Arbeit genutzten Bibliotheken näher erläutert.}
...
\todo{vielleicht noch ein zwei Sätze dazu schreiben?}
		...
		{ \label{YOLOv8_canu}
		In dieser Arbeit werden die \glqq-seq\grqq{} Modelle von YOLO benutzt, da diese bereits eine Segmentierung der Objekte mit deren Umrissen integriert haben. Für eine detaillierte Beschreibung siehe Kap. \ref{subsec:YOLOv8_theoretic}. \\
	...
	\section{weitere Algorithmen (NICHT FERTIG)}
	{ \todo{muss noch geschrieben werden}
		\begin{itemize}
			\item Quicksort/Mergesort noch erläutern? wg benutzung zur Sortieren von Sortarray?
		\end{itemize}
