...
\begin{figure}[h]
    \centering
    \includegraphics*[scale = 1, keepaspectratio]{images/yolo_comp/yolo_mean_prec.png}
    \caption[Vergleich der durchschnittlichen Präzision bei verschiedenen Objektdetetkionsalgorithmen]{Vergleich der durchschnittlichen Präzision bei verschiedenen Objektdetetkionsalgorithmen \citep{Pavani2022}}
