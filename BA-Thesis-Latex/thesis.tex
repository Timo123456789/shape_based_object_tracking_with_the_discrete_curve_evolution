...
\input{chapter/02Objekterkennung.tex}
\cleardoubleoddemptypage

\input{chapter/03Formverarbeitung.tex}
\cleardoubleoddemptypage

\input{chapter/04verwendeteTechnologie.tex}
\cleardoubleoddemptypage

\input{chapter/05implementierung.tex}
\cleardoubleoddemptypage


\input{chapter/06evaluation.tex}
\cleardoubleoddemptypage


\input{chapter/07discussion.tex}
\cleardoubleoddemptypage


\input{chapter/08conclusion.tex}
\cleardoubleoddemptypage
...
\input{chapter/09appendix_chapter.tex}
\cleardoubleoddemptypage
